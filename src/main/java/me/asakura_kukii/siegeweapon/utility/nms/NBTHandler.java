...
public class NBTHandler {
    public static boolean hasSiegeWeaponCompoundTag(ItemStack iS) {
        if (iS != null && SiegeWeapon.pluginName != null && iS.getItemMeta() != null && iS.getItemMeta().hasCustomModelData()) {
            ...
            if(nmsItemStack.hasTag()) {
                ...
                if(NBTCompound.contains(SiegeWeapon.pluginName)) {
                    CompoundTag cT = (CompoundTag) NBTCompound.get(SiegeWeapon.pluginName);
                    assert cT != null;
                    return true;
                }
            }
    ...
    public static Boolean contains(ItemStack iS, String s) {
        if (iS != null && SiegeWeapon.pluginName != null) {
            ItemStack clonedIS = iS.clone();
            net.minecraft.world.item.ItemStack nmsItemStack = CraftItemStack.asNMSCopy(clonedIS);
            if(nmsItemStack.hasTag()) {
                CompoundTag NBTCompound = nmsItemStack.getTag();
        ...
        if (iS != null && SiegeWeapon.pluginName != null) {
            ...
            if(nmsItemStack.hasTag()) {
                ...
                if(NBTCompound.contains(SiegeWeapon.pluginName)) {
                    ...
                    NBTCompound.remove(SiegeWeapon.pluginName);
                    NBTCompound.put(SiegeWeapon.pluginName, cT);
                }
    ...
    public static ItemStack set(ItemStack iS, String s, Object o, Boolean b) {
        if (iS != null && SiegeWeapon.pluginName != null) {
            ...
            if(!NBTCompound.contains(SiegeWeapon.pluginName)) {
                ...
                cT = (CompoundTag) NBTCompound.get(SiegeWeapon.pluginName);
                assert cT != null;
                cT = set(cT, s, o, b);
                NBTCompound.remove(SiegeWeapon.pluginName);
                NBTCompound.put(SiegeWeapon.pluginName, cT);
