        ...
        if (cS.contains(path)) {
            ...
            if (s.matches("")) {
                if (notEmpty) {
                    ...
                    FileIO.fileMessageMapper.put(fileName, FileIO.fileMessageMapper.get(fileName) + SiegeWeapon.consolePluginPrefix + path + " is empty\n");
                } else {
                    FileIO.fileMessageMapper.put(fileName, FileIO.fileMessageMapper.get(fileName) + SiegeWeapon.consolePluginPrefix + path + " is empty, neglected\n");
                }
                return obj;
            } else {
                ...
                if (obj instanceof Integer) {
                    try {
                        ...
                        FileIO.fileStatusMapper.put(fileName, false);
                        FileIO.fileMessageMapper.put(fileName, FileIO.fileMessageMapper.get(fileName) + SiegeWeapon.consolePluginPrefix + currentPath + path + " is not Integer\n");
                        return obj;
                    }
                }
                if (obj instanceof Float) {
                    try {
                        ...
                        FileIO.fileStatusMapper.put(fileName, false);
                        FileIO.fileMessageMapper.put(fileName, FileIO.fileMessageMapper.get(fileName) + SiegeWeapon.consolePluginPrefix + currentPath + path + " is not Float\n");
                        return obj;
                    }
                }
                if (obj instanceof Double) {
                    try {
                        ...
                        FileIO.fileStatusMapper.put(fileName, false);
                        FileIO.fileMessageMapper.put(fileName, FileIO.fileMessageMapper.get(fileName) + SiegeWeapon.consolePluginPrefix + currentPath + path + " is not Double\n");
                        return obj;
                    }
                }
                if (obj instanceof Boolean) {
                    if (s.matches("true") || s.matches("false")) {
                        ...
                        FileIO.fileStatusMapper.put(fileName, false);
                        FileIO.fileMessageMapper.put(fileName, FileIO.fileMessageMapper.get(fileName) + SiegeWeapon.consolePluginPrefix + currentPath + path + " is not Boolean\n");
                        return obj;
                    }
                }
                if (obj instanceof Vector3D) {
                    if (checkVectorFormat(s)) {
                        ...
                        FileIO.fileStatusMapper.put(fileName, false);
                        FileIO.fileMessageMapper.put(fileName, FileIO.fileMessageMapper.get(fileName) + SiegeWeapon.consolePluginPrefix + currentPath + path + " is not Vector3D\n");
                        return obj;
                    }
                }
                ...
                if (obj instanceof Material) {
                    if (Material.matchMaterial(s) != null) {
                        ...
                        FileIO.fileStatusMapper.put(fileName, false);
                        FileIO.fileMessageMapper.put(fileName, FileIO.fileMessageMapper.get(fileName) + SiegeWeapon.consolePluginPrefix + currentPath + path + " is not Material\n");
                        return obj;
                    }
                }
                if (obj instanceof Particle) {
                    try {
                        ...
                        FileIO.fileStatusMapper.put(fileName, false);
                        FileIO.fileMessageMapper.put(fileName, FileIO.fileMessageMapper.get(fileName) + SiegeWeapon.consolePluginPrefix + currentPath + path + " is not Particle\n");
                        return obj;
                    }
                }
                if (obj instanceof Color) {
                    if (s.matches("white")) {
                        ...
                        FileIO.fileStatusMapper.put(fileName, false);
                        FileIO.fileMessageMapper.put(fileName, FileIO.fileMessageMapper.get(fileName) + SiegeWeapon.consolePluginPrefix + currentPath + path + " is not Color\n");
                        return obj;
                    }
                }
                if (obj instanceof Enchantment) {
                    if (Enchantment.getByKey(NamespacedKey.minecraft(path)) != null) {
                        try {
                            ...
                            FileIO.fileStatusMapper.put(fileName, false);
                            FileIO.fileMessageMapper.put(fileName, FileIO.fileMessageMapper.get(fileName) + SiegeWeapon.consolePluginPrefix + currentPath + path + " is not Enchantment\n");
                            return obj;
                        }
                    } else {
                        FileIO.fileStatusMapper.put(fileName, false);
                ...
                if (obj instanceof HandData) {
                    if (FileType.HAND.map.containsKey(s)) {
                        ...
                        FileIO.fileStatusMapper.put(fileName, false);
                        FileIO.fileMessageMapper.put(fileName, FileIO.fileMessageMapper.get(fileName) + SiegeWeapon.consolePluginPrefix + currentPath + path + " is not hand\n");
                        return obj;
                    }
                }
                if (obj instanceof ReloadType) {
                    try {
                        ...
                        FileIO.fileStatusMapper.put(fileName, false);
                        FileIO.fileMessageMapper.put(fileName, FileIO.fileMessageMapper.get(fileName) + SiegeWeapon.consolePluginPrefix + currentPath + path + " is not ReloadType\n");
                        return obj;
                    }
                }
                if (obj instanceof MethodType) {
                    try {
                        ...
                        FileIO.fileStatusMapper.put(fileName, false);
                        FileIO.fileMessageMapper.put(fileName, FileIO.fileMessageMapper.get(fileName) + SiegeWeapon.consolePluginPrefix + currentPath + path + " is not MethodType\n");
                        return obj;
                    }
                }
            }
            ...
            if (notEmpty) {
                FileIO.fileStatusMapper.put(fileName, false);
                FileIO.fileMessageMapper.put(fileName, FileIO.fileMessageMapper.get(fileName) + SiegeWeapon.consolePluginPrefix + currentPath + path + " does not exist\n");
            } else {
                FileIO.fileMessageMapper.put(fileName, FileIO.fileMessageMapper.get(fileName) + SiegeWeapon.consolePluginPrefix + currentPath + path + " does not exist, neglected\n");
            }
        }
        return obj;
    }
    ...
    public static List<Material> materialListCreator(ConfigurationSection cS, String fN, String path, List<String> sL) {
        ...
        for (String s : sL) {
            if (Material.matchMaterial(s) != null) {
                ...
                FileIO.fileMessageMapper.put(fN, FileIO.fileMessageMapper.get(fN) + SiegeWeapon.consolePluginPrefix + currentPath + path + "-" + s + " is not Material\n");
            }
        }
        return mL;
    }
    ...
    public static List<Vector3D> vector3DListCreator(ConfigurationSection cS, String fN, String path, List<String> sL) {
        ...
        for (String s : sL) {
            if (checkVectorFormat(s)) {
                ...
                FileIO.fileStatusMapper.put(fN, false);
                FileIO.fileMessageMapper.put(fN, FileIO.fileMessageMapper.get(fN) + SiegeWeapon.consolePluginPrefix + currentPath + path + "-" + s + " is not Vector\n");
            }
        }
        return vL;
    }
    public static List<ParticleData> particleDataListCreator(ConfigurationSection cS, String fN, String path, List<String> sL) {
        ...
        for (String s : sL) {
            if (FileType.PARTICLE.map.containsKey(s)) {
                ...
                FileIO.fileStatusMapper.put(fN, false);
                FileIO.fileMessageMapper.put(fN, FileIO.fileMessageMapper.get(fN) + SiegeWeapon.consolePluginPrefix + currentPath + path + "-" + s + " is not ParticleData\n");
            }
        }
        return pDL;
    }
    public static List<SoundData> soundDataListCreator(ConfigurationSection cS, String fN, String path, List<String> sL) {
        ...
        for (String s : sL) {
            if (FileType.SOUND.map.containsKey(s)) {
                ...
                FileIO.fileStatusMapper.put(fN, false);
                FileIO.fileMessageMapper.put(fN, FileIO.fileMessageMapper.get(fN) + SiegeWeapon.consolePluginPrefix + currentPath + path + "-" + s + " is not SoundData\n");
            }
        }
        return sDL;
    }
    public static HashMap<Material, Double> breakableBlockMapCreator(ConfigurationSection cS, String fN, String path, List<String> sL) {
        ...
        for (String s : sL) {
            if (checkBreakableBlockFormat(s)) {
                ...
                FileIO.fileStatusMapper.put(fN, false);
                FileIO.fileMessageMapper.put(fN, FileIO.fileMessageMapper.get(fN) + SiegeWeapon.consolePluginPrefix + currentPath + path + "-" + s + " is not block map\n");
            }
        }
        return bBM;
    }
    public static HashMap<Material, Material> replaceableBlockMapCreator(ConfigurationSection cS, String fN, String path, List<String> sL) {
        ...
        for (String s : sL) {
            if (checkReplaceableBlockFormat(s)) {
                ...
                FileIO.fileStatusMapper.put(fN, false);
                FileIO.fileMessageMapper.put(fN, FileIO.fileMessageMapper.get(fN) + SiegeWeapon.consolePluginPrefix + currentPath + path + "-" + s + " is not replaceable block map\n");
            }
        }
        return rBM;
    }
    public static HashMap<String, Integer> gunModificationListCreator(ConfigurationSection cS, String fN, String path, List<String> sL) {
        ...
        for (String s : sL) {
            if (checkGunModificationFormat(s)) {
                ...
                FileIO.fileStatusMapper.put(fN, false);
                FileIO.fileMessageMapper.put(fN, FileIO.fileMessageMapper.get(fN) + SiegeWeapon.consolePluginPrefix + currentPath + path + "-" + s + " is not Gun Modification\n");
            }
        }
        return gMM;
    }
